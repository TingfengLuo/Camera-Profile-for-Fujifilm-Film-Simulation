...
If you are seeking simulation through `.dcp` file only (perceptually no difference besides some minor histogram changes when I compared), see my other repo [Fujifilm-Camera-Profile-for-Sony-a7c2](https://github.com/TingfengLuo/Fujifilm-Camera-Profile-for-Sony-a7c2) (that repo won't be updated in the future). You can also follow the procedure described in [FujifilmCameraProfiles](https://github.com/abpy/FujifilmCameraProfiles) to manually curate your own `.dcp` file tailored for your camera model.
## 🎬 Before-and-After
...
<table>
  ...
  <tr>
    <td align="center">
      <img src="demo%20images/Reala%20Ace.jpg" width="100%"><br/>
      <sub><b>Reala Ace</b></sub>
    </td>
    <td align="center">
      <img src="demo%20images/Bleach%20Bypass.jpg" width="100%"><br/>
      <sub><b>Bleach Bypass</b></sub>
    </td>
    <td align="center">
      <img src="demo%20images/Nostalgic%20Neg.jpg" width="100%"><br/>
...
| Film Simulation | Look / Color Character | Best For |
| --- | --- | --- |
| **Provia** | Neutral, balanced contrast & saturation. | Everyday “baseline”, product, general use. |
| **Velvia** | Very vivid color, deep contrast (strong greens/blues). | Landscapes, travel, anything that wants punch. |
| **Astia** | Softer contrast, gentle color, flattering skin. | Portraits, people, weddings. |
| **Classic Chrome** | Muted color, lifted shadows, subtle retro vibe. | Street, documentary, reportage. |
| **Classic Neg** | Higher contrast, muted tones, film-like warmth/cool shadows. | Urban scenes, moody portraits, overcast light. |
| **Eterna** | Low saturation, soft highlights, cinematic base. | Video, cinematic stills, scenes you’ll grade later. |
| **Pro Neg Std** | Low contrast, natural color, smooth tones. | Studio portraits, color-critical work. |
| **Pro Neg Hi** | Pro Neg Std but with more contrast/saturation. | Events, indoor light, crisp natural portraits. |
| **Nostalgic Neg** | Warm highlights, softer contrast, “golden” film feel. | Golden hour, portraits, lifestyle. |
| **Reala Ace** | Natural color with rich depth; clean but not flat. | Everyday, skin tones, mixed lighting. |
| **Bleach Bypass** | Desaturated, high contrast, gritty / dramatic. | Moody scenes, urban/night, cinematic looks. |
...
## 📁 File Description
* **`*Wrapper.xmp`** files ending in `LUT.xmp` are **preset wrappers**.  
...
## 📷✅ Supported Models
All models currently supported by Adobe CameraRaw v18.1 (sums up to 1464 different models), see following 
| Brand | Model |
|-------|--------------|
